...
describe("Test Ocpp Client Connection methods", function () {
    beforeEach(function () {
        ocppCl = new OcppClient_1.OcppClient("testId");
    });
    it("Test method 'callRequest'. Should run method 'callRequest' correctly ", function () { return __awaiter(void 0, void 0, void 0, function () {
        var boot;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ocppCl.callRequest("BootNotification", boot)];
                case 1:
                    _a.sent();
    ...
    it("Test method 'on'. Should run method 'on' correctly", function () {
        globals_1.jest.spyOn(ocppCl, "on");
        ocppCl.on("CancelReservation", globals_1.jest.fn());
    ...
    it("Test method 'connect'. Should run method 'connect' correctly", function () {
        globals_1.jest.spyOn(ocppCl, "connect");
