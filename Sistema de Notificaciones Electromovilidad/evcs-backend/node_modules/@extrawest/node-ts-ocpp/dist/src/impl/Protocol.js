...
var Protocol = /** @class */ (function () {
    ...
    /* istanbul ignore next */
    Protocol.prototype.onCallError = function (messageId, errorCode, errorDescription, 
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    errorDetails) {
    ...
    /* istanbul ignore next */
    Protocol.prototype.onCallResult = function (messageId, 
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    payload) {
        if (this.pendingCalls[messageId]) {
    ...
    /* istanbul ignore next */
    Protocol.prototype.onCall = function (messageId, 
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    request, 
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    payload) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                ...
                                var hasListener = _this.eventEmitter.emit(request, payload, 
                                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                                function (result) {
                                    resolve(result);
                                });
    ...
    /* istanbul ignore next */
    Protocol.prototype.callResult = function (messageId, action, 
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    responsePayload) {
        try {
